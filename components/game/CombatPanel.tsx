...
export const CombatPanel: React.FC<CombatPanelProps> = ({ 
  ...
  const formatCost = (cost: any) => {
      ...
      if (typeof cost === 'object') {
          const parts: string[] = [];
          if (cost.Load !== undefined) parts.push(`负载 ${cost.Load}`);
          if (cost.Stamina !== undefined) parts.push(`体力 ${cost.Stamina}`);
          if (cost.Credits !== undefined) parts.push(`配给 ${cost.Credits}`);
          if (cost.精神 !== undefined && cost.精神 !== null && cost.精神 !== '') parts.push(`MP ${cost.精神}`);
          if (cost.体力 !== undefined && cost.体力 !== null && cost.体力 !== '' && cost.Stamina === undefined) parts.push(`体力 ${cost.体力}`);
